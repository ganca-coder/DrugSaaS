 ...
 * 复杂 SQL 预留 XML 方式实现，见 {@code resources/mapper/RejectionOrderItemMapper.xml}。
 */
@Mapper
public interface RejectionOrderItemMapper extends BaseMapper<RejectionOrderItem> {
