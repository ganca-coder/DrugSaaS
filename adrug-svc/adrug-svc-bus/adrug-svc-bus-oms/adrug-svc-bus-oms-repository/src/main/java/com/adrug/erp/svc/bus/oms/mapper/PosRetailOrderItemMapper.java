 ...
 * 复杂 SQL 预留 XML 方式实现，见 {@code resources/mapper/PosRetailOrderItemMapper.xml}。
 */
@Mapper
public interface PosRetailOrderItemMapper extends BaseMapper<PosRetailOrderItem> {
